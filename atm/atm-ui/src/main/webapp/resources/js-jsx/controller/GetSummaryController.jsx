class GetSummaryController extends React.Component {
    ...
    render() {
        return (<AccountSummary accountNumber={this.state.accountNumber} statusCode={this.state.responseStatus} accountType={this.state.accountType} balance={this.state.balance}/>);
    }
}
