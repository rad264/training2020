describe("TicTacToe", function() {
    ...
    describe("isGameOver", function() {
        it("gameOver if top row is filled with X's", function() {
            game.squares[0][0] = true;
            game.squares[1][0] = true;
            game.click(2, 0);
            expect(game.gameOver).toBe(true);
        });
        it("gameOver if middle row is filled with X's", function() {
            game.squares[0][1] = true;
            game.squares[1][1] = true;
            game.click(2, 1);
            expect(game.gameOver).toBe(true);
        });
        it("gameOver if bottom row is filled with X's", function() {
            game.squares[0][2] = true;
            game.squares[1][2] = true;
            game.click(2, 2);
            expect(game.gameOver).toBe(true);
        });
        it("gameOver if left column is filled with X's", function() {
            game.squares[0][0] = true;
            game.squares[0][1] = true;
            game.click(0, 2);
            expect(game.gameOver).toBe(true);
        });
        it("gameOver if middle column is filled with X's", function() {
            game.squares[1][0] = true;
            game.squares[1][1] = true;
            game.click(1, 2);
            expect(game.gameOver).toBe(true);
        ...
        it("gameOver if diagonal (top-left to bottom-right) is filled with X's", function() {
            game.squares[0][0] = true;
            game.squares[1][1] = true;
            game.click(2, 2);
            expect(game.gameOver).toBe(true);
        });
        it("gameOver if diagonal (bottom-left to top-right) is filled with X's", function() {
            game.squares[0][2] = true;
            game.squares[1][1] = true;
            game.click(2, 0);
            expect(game.gameOver).toBe(true);
